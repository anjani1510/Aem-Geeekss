...
public class PagePublishEventHandler implements EventHandler {
    ...
    @Reference
    private ResourceResolverFactory resourceResolverFactory; // Use ResourceResolverFactory to obtain ResourceResolver

    @Override
    public void handleEvent(Event event) {
        String[] paths = (String[]) event.getProperty("paths");
        LOG.info("Handling event for paths: {}", (Object[]) paths); // Log the paths being handled
    ...
    private ResourceResolver getResourceResolver() {
        ...
        try {
            ...
            param.put(ResourceResolverFactory.SUBSERVICE, "anjani");
